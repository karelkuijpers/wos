...
FONT	8, "MS Shell Dlg"
BEGIN
	CONTROL	"", DUEAMOUNTBROWSER_MPERSON, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 56, 14, 100, 13, WS_EX_CLIENTEDGE
	CONTROL	"", DUEAMOUNTBROWSER_MACCOUNT, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 56, 29, 100, 12, WS_EX_CLIENTEDGE
	...
	CONTROL	"v", DUEAMOUNTBROWSER_PERSONBUTTON, "Button", WS_CHILD, 156, 14, 15, 13
	CONTROL	"v", DUEAMOUNTBROWSER_ACCBUTTON, "Button", WS_CHILD, 156, 29, 16, 12
	CONTROL	"Due Amounts", DUEAMOUNTBROWSER_GROUPBOX1, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 8, 56, 462, 195
	CONTROL	"Select due amounts of:", DUEAMOUNTBROWSER_GROUPBOX2, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 8, 3, 176, 50
	CONTROL	"", DUEAMOUNTBROWSER_FOUND, "Static", SS_CENTERIMAGE|WS_CHILD, 260, 7, 47, 12
	CONTROL	"Found:", DUEAMOUNTBROWSER_FOUNDTEXT, "Static", SS_CENTERIMAGE|WS_CHILD, 224, 8, 27, 12
END
