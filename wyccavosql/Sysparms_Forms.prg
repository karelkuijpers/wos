...
// 	instance mHomeIncAc 
   ...
   protect oSys as SQLSelect
RESOURCE Tab_Parm2 DIALOGEX  44, 36, 292, 264
STYLE	WS_CHILD
FONT	8, "MS Shell Dlg"
BEGIN
	...
	CONTROL	"", TAB_PARM2_MGIFTINCAC, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 112, 96, 161, 13, WS_EX_CLIENTEDGE
	CONTROL	"v", TAB_PARM2_INCBUTTON, "Button", WS_CHILD, 272, 96, 15, 12
	CONTROL	"", TAB_PARM2_MGIFTEXPAC, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 112, 110, 161, 13, WS_EX_CLIENTEDGE
	CONTROL	"v", TAB_PARM2_EXPBUTTON, "Button", WS_CHILD, 272, 110, 15, 13
	CONTROL	"", TAB_PARM2_MHOMEINCAC, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 112, 129, 161, 13, WS_EX_CLIENTEDGE
	CONTROL	"v", TAB_PARM2_INCBUTTONHOME, "Button", WS_CHILD|NOT WS_VISIBLE, 272, 129, 16, 12
	CONTROL	"", TAB_PARM2_MHOMEEXPAC, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 112, 144, 161, 12, WS_EX_CLIENTEDGE
	CONTROL	"v", TAB_PARM2_EXPBUTTONHOME, "Button", WS_CHILD|NOT WS_VISIBLE, 272, 144, 15, 12
	...
	CONTROL	"", TAB_PARM2_MPERSONPMCMAN, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 112, 228, 161, 13, WS_EX_CLIENTEDGE
	CONTROL	"Email account of IES:", TAB_PARM2_IESMAILACC, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 112, 243, 174, 13, WS_EX_CLIENTEDGE
	CONTROL	"v", TAB_PARM2_PERSONBUTTONCONTACT, "Button", WS_CHILD, 272, 228, 13, 12
	...
	CONTROL	"", TAB_PARM2_MASSFLDAC, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 112, 62, 161, 13, WS_EX_CLIENTEDGE
	CONTROL	"v", TAB_PARM2_ASSFLDACBUTTON, "Button", WS_CHILD|NOT WS_VISIBLE, 272, 62, 16, 13
...
//   	
   ...
   protect oSys as SQLSelect
RESOURCE Tab_Parm5 DIALOGEX  20, 18, 259, 265
STYLE	WS_CHILD
FONT	8, "MS Shell Dlg"
BEGIN
	...
	CONTROL	"", TAB_PARM5_MFGCOD3, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 148, 199, 61, 72
	CONTROL	"", TAB_PARM5_MFGCOD2, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 84, 199, 61, 72
	CONTROL	"", TAB_PARM5_MFGCOD1, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 20, 199, 61, 72
	...
	CONTROL	"Emailing", TAB_PARM5_EMAILING, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 9, 110, 216, 37
...
oCCClientButton:TooltipText := "Send email vai external email client"
...
RESOURCE TabSysParms DIALOGEX  38, 35, 316, 307
STYLE	WS_CHILD
FONT	8, "MS Shell Dlg"
BEGIN
	CONTROL	"", TABSYSPARMS_TABPARM, "SysTabControl32", WS_CHILD, 4, 7, 308, 281
	CONTROL	"OK", TABSYSPARMS_OKBUTTON, "Button", BS_DEFPUSHBUTTON|WS_TABSTOP|WS_CHILD, 192, 291, 53, 13
	CONTROL	"Cancel", TABSYSPARMS_CANCELBUTTON, "Button", WS_TABSTOP|WS_CHILD, 257, 291, 53, 13
END
