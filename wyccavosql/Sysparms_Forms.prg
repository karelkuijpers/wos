...
FONT	8, "MS Shell Dlg"
BEGIN
	CONTROL	"Source:", EDITLOG_FIXEDTEXT1, "Static", WS_CHILD, 12, 11, 44, 13
	CONTROL	"", EDITLOG_SOURCE, "Edit", ES_READONLY|ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 64, 11, 131, 12, WS_EX_CLIENTEDGE
	CONTROL	"Date & Time:", EDITLOG_FIXEDTEXT2, "Static", WS_CHILD, 248, 11, 47, 12
	CONTROL	"", EDITLOG_LOGTIME, "Edit", ES_READONLY|ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 308, 11, 103, 12, WS_EX_CLIENTEDGE
...
CLASS LogReport INHERIT DataWindowExtra 
  ...
  export cWhere,cFields,cOrder as string 
  
RESOURCE LogReport DIALOGEX  4, 3, 386, 309
STYLE	WS_CHILD
FONT	8, "MS Shell Dlg"
BEGIN
	CONTROL	"4-5-2011", LOGREPORT_DATETIMEFROM, "SysDateTimePick32", WS_TABSTOP|WS_CHILD, 44, 7, 56, 13
	CONTROL	"4-5-2011", LOGREPORT_DATETIMETO, "SysDateTimePick32", WS_TABSTOP|WS_CHILD, 120, 7, 56, 13
	CONTROL	"From", LOGREPORT_FIXEDTEXT1, "Static", WS_CHILD, 12, 8, 28, 12
	CONTROL	"till", LOGREPORT_FIXEDTEXT2, "Static", WS_CHILD, 104, 8, 20, 12
	CONTROL	"", LOGREPORT_COLLECTIONBOX, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 228, 7, 79, 41
	CONTROL	"Collection:", LOGREPORT_COLLECTIONTEXT, "Static", WS_CHILD, 184, 8, 40, 12
	CONTROL	"", LOGREPORT_SUB_LOGREPORT, "static", WS_CHILD|WS_BORDER, 4, 22, 377, 280
END
...
Method GetLog()  class LogReport 
	self:oLog:SQLString:="select "+self:cFields+" from log "+;
		...
		"' and '"+SQLdate(self:oDCDateTimeTo:SelectedDate+1)+"' "+self:cOrder
	self:oLog:Execute()
	return 
...
SELF:HyperLabel := HyperLabel{#LogReport,"DataWindow Caption",NULL_STRING,NULL_STRING}
...
method PreInit(oWindow,iCtlID,oServer,uExtra) class LogReport
	...
	self:cFields:= sIdentChar+"source"+sIdentChar+","+sIdentChar+"logtime"+sIdentChar+","+sIdentChar+"message"+sIdentChar
