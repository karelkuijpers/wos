...
BEGIN
	...
	CONTROL	"Prefix:", NEWPERSONWINDOW_SC_HISN, "Static", WS_CHILD, 216, 9, 32, 13
	CONTROL	"First (&&middle) name(s):", NEWPERSONWINDOW_SC_VRN, "Static", WS_CHILD, 11, 19, 51, 17
	CONTROL	"Initials:", NEWPERSONWINDOW_SC_NA2, "Static", WS_CHILD, 216, 23, 23, 12
	CONTROL	"Name extension:", NEWPERSONWINDOW_SC_NA3, "Static", WS_CHILD, 10, 36, 54, 12
	CONTROL	"Title:", NEWPERSONWINDOW_SC_TIT, "Static", WS_CHILD, 216, 36, 28, 13
	CONTROL	"Street+number:", NEWPERSONWINDOW_SC_AD1, "Static", WS_CHILD, 12, 66, 48, 12
	CONTROL	"Zip code:", NEWPERSONWINDOW_SC_POS, "Static", WS_CHILD, 12, 94, 32, 11
	CONTROL	"City:", NEWPERSONWINDOW_SC_PLA, "Static", WS_CHILD, 105, 92, 15, 13
	CONTROL	"Attention:", NEWPERSONWINDOW_SC_TAV, "Static", WS_CHILD, 216, 64, 32, 12
	CONTROL	"Country:", NEWPERSONWINDOW_SC_LAN, "Static", WS_CHILD, 216, 92, 28, 12
	CONTROL	"Business:", NEWPERSONWINDOW_SC_TEL1, "Static", WS_CHILD, 12, 124, 51, 13
	CONTROL	"Home:", NEWPERSONWINDOW_SC_TEL2, "Static", WS_CHILD, 216, 124, 22, 12
	CONTROL	"Fax:", NEWPERSONWINDOW_SC_FAX, "Static", WS_CHILD, 13, 137, 43, 12
	CONTROL	"Remarks:", NEWPERSONWINDOW_SC_OPM, "Static", WS_CHILD, 216, 188, 32, 12
	CONTROL	"", NEWPERSONWINDOW_MLASTNAME, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 65, 9, 143, 13
	CONTROL	"", NEWPERSONWINDOW_MPREFIX, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 256, 7, 133, 12
	CONTROL	"", NEWPERSONWINDOW_MFIRSTNAME, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 65, 23, 143, 12
	CONTROL	"", NEWPERSONWINDOW_MINITIALS, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 256, 22, 133, 12
	CONTROL	"", NEWPERSONWINDOW_MNAMEEXT, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 65, 36, 143, 13
	CONTROL	"Salutation", NEWPERSONWINDOW_MTITLE, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 256, 36, 133, 72
	CONTROL	"", NEWPERSONWINDOW_MADDRESS, "Edit", ES_WANTRETURN|ES_AUTOHSCROLL|ES_AUTOVSCROLL|ES_MULTILINE|WS_TABSTOP|WS_CHILD|WS_BORDER, 65, 64, 143, 26, WS_EX_CLIENTEDGE
	CONTROL	"", NEWPERSONWINDOW_MPOSTALCODE, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 65, 92, 37, 13
	CONTROL	"", NEWPERSONWINDOW_MCITY, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 120, 92, 88, 13
	CONTROL	"", NEWPERSONWINDOW_MATTENTION, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 256, 64, 133, 12
	CONTROL	"", NEWPERSONWINDOW_MCOUNTRY, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 256, 94, 133, 12
	CONTROL	"", NEWPERSONWINDOW_MTELBUSINESS, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 65, 123, 143, 13
	CONTROL	"", NEWPERSONWINDOW_MTELHOME, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 256, 124, 133, 13
	CONTROL	"", NEWPERSONWINDOW_MFAX, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 65, 137, 143, 12
	CONTROL	"", NEWPERSONWINDOW_MMOBILE, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 256, 139, 133, 13
	CONTROL	"", NEWPERSONWINDOW_MBANKNUMBER, "Edit", ES_AUTOHSCROLL|ES_NUMBER|WS_TABSTOP|WS_CHILD|WS_BORDER, 65, 166, 131, 12
	CONTROL	"v", NEWPERSONWINDOW_BANKBUTTON, "Button", WS_CHILD, 196, 166, 13, 12
	CONTROL	"", NEWPERSONWINDOW_MBIC, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 256, 166, 133, 12, WS_EX_CLIENTEDGE
	CONTROL	"", NEWPERSONWINDOW_BANKBOX, "ListBox", LBS_DISABLENOSCROLL|LBS_NOINTEGRALHEIGHT|LBS_NOTIFY|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER|WS_VSCROLL, 65, 179, 143, 35, WS_EX_CLIENTEDGE
	CONTROL	"", NEWPERSONWINDOW_MEMAIL, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 65, 214, 143, 12, WS_EX_CLIENTEDGE
	CONTROL	"", NEWPERSONWINDOW_MREMARKS, "Edit", ES_WANTRETURN|ES_AUTOHSCROLL|ES_AUTOVSCROLL|ES_MULTILINE|WS_TABSTOP|WS_CHILD|WS_BORDER, 256, 188, 230, 38
	...
	CONTROL	"", NEWPERSONWINDOW_MGENDER, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 340, 240, 145, 63
	...
	CONTROL	"", NEWPERSONWINDOW_MCOD1, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 402, 59, 93, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD2, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 402, 70, 93, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD3, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 402, 82, 93, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD4, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 402, 94, 93, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD5, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 402, 105, 93, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD6, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 402, 117, 93, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD7, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 402, 129, 93, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD8, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 402, 140, 93, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD9, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 402, 152, 93, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD10, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 402, 164, 93, 72
	...
	CONTROL	"OK", NEWPERSONWINDOW_OKBUTTON, "Button", BS_DEFPUSHBUTTON|WS_TABSTOP|WS_CHILD, 446, 18, 47, 12
	CONTROL	"Cancel", NEWPERSONWINDOW_CANCELBUTTON, "Button", WS_TABSTOP|WS_CHILD, 396, 18, 46, 12
	CONTROL	"Email:", NEWPERSONWINDOW_FIXEDTEXT21, "Static", WS_CHILD, 12, 214, 22, 12
	CONTROL	"Bank# 1", NEWPERSONWINDOW_SC_BANKNUMBER, "Static", WS_CHILD, 12, 166, 53, 12
	CONTROL	"Intern ID:", NEWPERSONWINDOW_SC_CLN, "Static", WS_CHILD, 400, 288, 30, 12
	CONTROL	"Mailing codes", NEWPERSONWINDOW_GROUPBOX1, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 396, 48, 103, 134
	...
	CONTROL	"Name:", NEWPERSONWINDOW_GROUPBOX2, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 6, 0, 388, 54
	CONTROL	"Address:", NEWPERSONWINDOW_GROUPBOX3, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 6, 57, 388, 50
	CONTROL	"Telephone:", NEWPERSONWINDOW_GROUPBOX4, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 8, 114, 388, 41
	CONTROL	"System:", NEWPERSONWINDOW_GROUPBOXSYSTEM, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 6, 278, 478, 38
	CONTROL	"Mobile:", NEWPERSONWINDOW_SC_TEL3, "Static", WS_CHILD, 216, 139, 22, 13
	CONTROL	"Personal:", NEWPERSONWINDOW_GROUPBOXPERSONAL, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 6, 232, 483, 43, WS_EX_TRANSPARENT
	...
	CONTROL	"Gifts", NEWPERSONWINDOW_GIFTSBUTTON, "Button", WS_TABSTOP|WS_CHILD, 446, 33, 47, 12
	CONTROL	"Donations", NEWPERSONWINDOW_DONATIONSBUTTON, "Button", WS_TABSTOP|WS_CHILD, 396, 33, 46, 13
	CONTROL	"Deleted", NEWPERSONWINDOW_DELETEDTEXT, "Static", SS_CENTER|WS_CHILD|NOT WS_VISIBLE, 432, 3, 61, 13
	CONTROL	"Undelete", NEWPERSONWINDOW_UNDELETE, "Button", BS_DEFPUSHBUTTON|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE, 448, 18, 44, 15
	CONTROL	"Bic 1", NEWPERSONWINDOW_BICTEXT, "Static", WS_CHILD, 216, 166, 35, 12
	CONTROL	"Bank account:", NEWPERSONWINDOW_GROUPBOX6, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 8, 155, 388, 25
END
...
cFilter:="p.persid="+self:mPersid+" and category='D'"
self:oSubBrws:=SubscriptionBrowser{self:owner,,,cFilter}
...
oDCmAddress := MultiLineEdit{SELF,ResourceID{NEWPERSONWINDOW_MADDRESS,_GetInst()}}
...
oDCDeletedText := FixedText{SELF,ResourceID{NEWPERSONWINDOW_DELETEDTEXT,_GetInst()}}
...
oCCUndelete := PushButton{SELF,ResourceID{NEWPERSONWINDOW_UNDELETE,_GetInst()}}
oCCUndelete:HyperLabel := HyperLabel{#Undelete,"Undelete",NULL_STRING,NULL_STRING}

oDCBicText := FixedText{SELF,ResourceID{NEWPERSONWINDOW_BICTEXT,_GetInst()}}
oDCBicText:HyperLabel := HyperLabel{#BicText,"Bic 1",NULL_STRING,NULL_STRING}

oDCGroupBox6 := GroupBox{SELF,ResourceID{NEWPERSONWINDOW_GROUPBOX6,_GetInst()}}
...
ACCESS mBic() CLASS NewPersonWindow
RETURN SELF:FieldGet(#mBic)

ASSIGN mBic(uValue) CLASS NewPersonWindow
...
// 			pos:=self:FillBankNbr(self:oPersCnt:m56_banknumber,self:oDCSC_BankNumber:TextValue,pos)
	...
	RETURN NIL
method PreInit(oWindow,iCtlID,oServer,uExtra) class NewPersonWindow
...
METHOD Undelete( ) CLASS NewPersonWindow
...
STATIC DEFINE NEWPERSONWINDOW_BICTEXT := 180 
STATIC DEFINE NEWPERSONWINDOW_CANCELBUTTON := 157 
STATIC DEFINE NEWPERSONWINDOW_DELETEDTEXT := 178 
STATIC DEFINE NEWPERSONWINDOW_DONATIONSBUTTON := 177 
STATIC DEFINE NEWPERSONWINDOW_FIXEDTEXT21 := 158 
STATIC DEFINE NEWPERSONWINDOW_GIFTSBUTTON := 176 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOX1 := 161 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOX2 := 166 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOX3 := 167 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOX4 := 168 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOX6 := 181 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOXPERSONAL := 171 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOXSYSTEM := 169 
STATIC DEFINE NEWPERSONWINDOW_MADDRESS := 121 
STATIC DEFINE NEWPERSONWINDOW_MALTERDATE := 152 
STATIC DEFINE NEWPERSONWINDOW_MATTENTION := 124 
STATIC DEFINE NEWPERSONWINDOW_MBANKNUMBER := 130 
STATIC DEFINE NEWPERSONWINDOW_MBIC := 132 
STATIC DEFINE NEWPERSONWINDOW_MBIRTHDATE := 138 
STATIC DEFINE NEWPERSONWINDOW_MCITY := 123 
STATIC DEFINE NEWPERSONWINDOW_MCOD1 := 140 
STATIC DEFINE NEWPERSONWINDOW_MCOD10 := 149 
STATIC DEFINE NEWPERSONWINDOW_MCOD2 := 141 
STATIC DEFINE NEWPERSONWINDOW_MCOD3 := 142 
STATIC DEFINE NEWPERSONWINDOW_MCOD4 := 143 
STATIC DEFINE NEWPERSONWINDOW_MCOD5 := 144 
STATIC DEFINE NEWPERSONWINDOW_MCOD6 := 145 
STATIC DEFINE NEWPERSONWINDOW_MCOD7 := 146 
STATIC DEFINE NEWPERSONWINDOW_MCOD8 := 147 
STATIC DEFINE NEWPERSONWINDOW_MCOD9 := 148 
STATIC DEFINE NEWPERSONWINDOW_MCOUNTRY := 125 
STATIC DEFINE NEWPERSONWINDOW_MCREATIONDATE := 150 
STATIC DEFINE NEWPERSONWINDOW_MDATELASTGIFT := 151 
STATIC DEFINE NEWPERSONWINDOW_MEMAIL := 134 
STATIC DEFINE NEWPERSONWINDOW_MEXTERNID := 155 
...
STATIC DEFINE NEWPERSONWINDOW_MOPC := 153 
STATIC DEFINE NEWPERSONWINDOW_MPERSID := 154 
STATIC DEFINE NEWPERSONWINDOW_MPOSTALCODE := 122 
STATIC DEFINE NEWPERSONWINDOW_MPREFIX := 116 
STATIC DEFINE NEWPERSONWINDOW_MPROPEXTR := 139 
STATIC DEFINE NEWPERSONWINDOW_MREMARKS := 135 
...
STATIC DEFINE NEWPERSONWINDOW_MTYPE := 136 
STATIC DEFINE NEWPERSONWINDOW_OKBUTTON := 156 
STATIC DEFINE NEWPERSONWINDOW_SC_AD1 := 106 
STATIC DEFINE NEWPERSONWINDOW_SC_BANKNUMBER := 159 
STATIC DEFINE NEWPERSONWINDOW_SC_BDAT := 162 
STATIC DEFINE NEWPERSONWINDOW_SC_BDAT1 := 172 
STATIC DEFINE NEWPERSONWINDOW_SC_BDAT2 := 173 
STATIC DEFINE NEWPERSONWINDOW_SC_CLN := 160 
STATIC DEFINE NEWPERSONWINDOW_SC_DLG := 164 
STATIC DEFINE NEWPERSONWINDOW_SC_EXTERNID := 175 
...
STATIC DEFINE NEWPERSONWINDOW_SC_TEL3 := 170 
STATIC DEFINE NEWPERSONWINDOW_SC_TEL4 := 174 
STATIC DEFINE NEWPERSONWINDOW_SC_TIT := 105 
STATIC DEFINE NEWPERSONWINDOW_SC_VRN := 102 
STATIC DEFINE NEWPERSONWINDOW_UNDELETE := 179 
