...
BEGIN
	...
	CONTROL	"Business:", NEWPERSONWINDOW_SC_TEL1, "Static", WS_CHILD, 12, 124, 35, 13
	CONTROL	"Home:", NEWPERSONWINDOW_SC_TEL2, "Static", WS_CHILD, 216, 124, 22, 12
	CONTROL	"Fax:", NEWPERSONWINDOW_SC_FAX, "Static", WS_CHILD, 13, 137, 16, 12
	CONTROL	"Remarks:", NEWPERSONWINDOW_SC_OPM, "Static", WS_CHILD, 216, 184, 32, 12
	...
	CONTROL	"", NEWPERSONWINDOW_MTELBUSINESS, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 67, 123, 143, 13
	CONTROL	"", NEWPERSONWINDOW_MTELHOME, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 256, 124, 133, 13
	CONTROL	"", NEWPERSONWINDOW_MFAX, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 67, 137, 143, 12
	CONTROL	"", NEWPERSONWINDOW_MMOBILE, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 256, 139, 133, 13
	CONTROL	"", NEWPERSONWINDOW_MBANKNUMBER, "Edit", ES_AUTOHSCROLL|ES_NUMBER|WS_TABSTOP|WS_CHILD|WS_BORDER, 66, 158, 130, 13
	CONTROL	"v", NEWPERSONWINDOW_BANKBUTTON, "Button", WS_CHILD, 196, 158, 13, 13
	CONTROL	"", NEWPERSONWINDOW_BANKBOX, "ListBox", LBS_DISABLENOSCROLL|LBS_NOINTEGRALHEIGHT|LBS_NOTIFY|WS_TABSTOP|WS_CHILD|WS_BORDER|WS_VSCROLL, 64, 171, 144, 57, WS_EX_CLIENTEDGE
	CONTROL	"", NEWPERSONWINDOW_MEMAIL, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 254, 158, 133, 13, WS_EX_CLIENTEDGE
	CONTROL	"", NEWPERSONWINDOW_MREMARKS, "Edit", ES_WANTRETURN|ES_AUTOHSCROLL|ES_AUTOVSCROLL|ES_MULTILINE|WS_TABSTOP|WS_CHILD|WS_BORDER, 254, 184, 230, 47
	...
	CONTROL	"", NEWPERSONWINDOW_MCOD1, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 59, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD2, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 70, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD3, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 82, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD4, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 94, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD5, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 105, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD6, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 117, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD7, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 129, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD8, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 140, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD9, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 152, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD10, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 164, 73, 72
	CONTROL	"OK", NEWPERSONWINDOW_OKBUTTON, "Button", BS_DEFPUSHBUTTON|WS_TABSTOP|WS_CHILD, 442, 16, 47, 12
	CONTROL	"Cancel", NEWPERSONWINDOW_CANCELBUTTON, "Button", WS_TABSTOP|WS_CHILD, 392, 16, 46, 12
	...
	CONTROL	"Email:", NEWPERSONWINDOW_FIXEDTEXT21, "Static", WS_CHILD, 216, 158, 22, 13
	CONTROL	"Bank/Giro:", NEWPERSONWINDOW_SC_BANKNUMBER, "Static", WS_CHILD, 12, 159, 52, 23
	...
	CONTROL	"Address:", NEWPERSONWINDOW_GROUPBOX3, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 6, 57, 383, 50
	CONTROL	"Telephone:", NEWPERSONWINDOW_GROUPBOX4, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 8, 114, 383, 41
	...
	CONTROL	"Gifts", NEWPERSONWINDOW_GIFTSBUTTON, "Button", WS_TABSTOP|WS_CHILD, 442, 30, 47, 13
	CONTROL	"Donations", NEWPERSONWINDOW_DONATIONSBUTTON, "Button", WS_TABSTOP|WS_CHILD, 392, 31, 46, 12
	CONTROL	"", NEWPERSONWINDOW_MADDRESS, "Edit", ES_WANTRETURN|ES_AUTOHSCROLL|ES_AUTOVSCROLL|ES_MULTILINE|WS_TABSTOP|WS_CHILD|WS_BORDER, 64, 64, 144, 26, WS_EX_CLIENTEDGE
	CONTROL	"Deleted", NEWPERSONWINDOW_DELETEDTEXT, "Static", SS_CENTER|WS_CHILD|NOT WS_VISIBLE, 428, 3, 61, 13
END
...
return
STATIC DEFINE NEWPERSONWINDOW_BANKBOX := 131 
STATIC DEFINE NEWPERSONWINDOW_BANKBUTTON := 130 
STATIC DEFINE NEWPERSONWINDOW_CANCELBUTTON := 148 
STATIC DEFINE NEWPERSONWINDOW_DELETEDTEXT := 177 
STATIC DEFINE NEWPERSONWINDOW_DONATIONSBUTTON := 175 
STATIC DEFINE NEWPERSONWINDOW_FIXEDTEXT21 := 150 
STATIC DEFINE NEWPERSONWINDOW_GIFTSBUTTON := 174 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOX1 := 153 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOX2 := 162 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOX3 := 163 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOX4 := 164 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOXPERSONAL := 167 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOXSYSTEM := 165 
STATIC DEFINE NEWPERSONWINDOW_MADDRESS := 176 
STATIC DEFINE NEWPERSONWINDOW_MALTERDATE := 159 
STATIC DEFINE NEWPERSONWINDOW_MATTENTION := 123 
STATIC DEFINE NEWPERSONWINDOW_MBANKNUMBER := 129 
STATIC DEFINE NEWPERSONWINDOW_MBIRTHDATE := 135 
STATIC DEFINE NEWPERSONWINDOW_MCITY := 122 
STATIC DEFINE NEWPERSONWINDOW_MCOD1 := 137 
STATIC DEFINE NEWPERSONWINDOW_MCOD10 := 146 
STATIC DEFINE NEWPERSONWINDOW_MCOD2 := 138 
STATIC DEFINE NEWPERSONWINDOW_MCOD3 := 139 
STATIC DEFINE NEWPERSONWINDOW_MCOD4 := 140 
STATIC DEFINE NEWPERSONWINDOW_MCOD5 := 141 
STATIC DEFINE NEWPERSONWINDOW_MCOD6 := 142 
STATIC DEFINE NEWPERSONWINDOW_MCOD7 := 143 
STATIC DEFINE NEWPERSONWINDOW_MCOD8 := 144 
STATIC DEFINE NEWPERSONWINDOW_MCOD9 := 145 
STATIC DEFINE NEWPERSONWINDOW_MCOUNTRY := 124 
STATIC DEFINE NEWPERSONWINDOW_MCREATIONDATE := 149 
STATIC DEFINE NEWPERSONWINDOW_MDATELASTGIFT := 160 
STATIC DEFINE NEWPERSONWINDOW_MEMAIL := 132 
STATIC DEFINE NEWPERSONWINDOW_MEXTERNID := 173 
STATIC DEFINE NEWPERSONWINDOW_MFAX := 127 
STATIC DEFINE NEWPERSONWINDOW_MFIRSTNAME := 117 
STATIC DEFINE NEWPERSONWINDOW_MGENDER := 136 
STATIC DEFINE NEWPERSONWINDOW_MINITIALS := 118 
STATIC DEFINE NEWPERSONWINDOW_MLASTNAME := 115 
STATIC DEFINE NEWPERSONWINDOW_MMOBILE := 128 
STATIC DEFINE NEWPERSONWINDOW_MNAMEEXT := 119 
STATIC DEFINE NEWPERSONWINDOW_MOPC := 161 
STATIC DEFINE NEWPERSONWINDOW_MPERSID := 154 
STATIC DEFINE NEWPERSONWINDOW_MPOSTALCODE := 121 
STATIC DEFINE NEWPERSONWINDOW_MPREFIX := 116 
STATIC DEFINE NEWPERSONWINDOW_MPROPEXTR := 171 
STATIC DEFINE NEWPERSONWINDOW_MREMARKS := 133 
STATIC DEFINE NEWPERSONWINDOW_MTELBUSINESS := 125 
STATIC DEFINE NEWPERSONWINDOW_MTELHOME := 126 
STATIC DEFINE NEWPERSONWINDOW_MTITLE := 120 
STATIC DEFINE NEWPERSONWINDOW_MTYPE := 134 
STATIC DEFINE NEWPERSONWINDOW_OKBUTTON := 147 
STATIC DEFINE NEWPERSONWINDOW_SC_AD1 := 106 
STATIC DEFINE NEWPERSONWINDOW_SC_BANKNUMBER := 151 
STATIC DEFINE NEWPERSONWINDOW_SC_BDAT := 155 
STATIC DEFINE NEWPERSONWINDOW_SC_BDAT1 := 168 
STATIC DEFINE NEWPERSONWINDOW_SC_BDAT2 := 169 
STATIC DEFINE NEWPERSONWINDOW_SC_CLN := 152 
STATIC DEFINE NEWPERSONWINDOW_SC_DLG := 157 
STATIC DEFINE NEWPERSONWINDOW_SC_EXTERNID := 172 
...
STATIC DEFINE NEWPERSONWINDOW_SC_TEL3 := 166 
STATIC DEFINE NEWPERSONWINDOW_SC_TEL4 := 170 
