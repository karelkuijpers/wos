...
// 	local cFields:="a.*,b.category as type,m.co,m.persid as persid,"+SQLAccType()+" as accounttype"  as string
	local cFields:="a.accid,a.accnumber,a.description,a.department,a.balitemid,a.currency,a.multcurr,a.active, if(active=0,'NO','') as activedesc,a.subscriptionprice,b.category as type,m.co,m.persid as persid,"+SQLAccType()+" as accounttype"  as string
