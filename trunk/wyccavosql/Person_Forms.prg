...
BEGIN
	...
	CONTROL	"", NEWPERSONWINDOW_MINITIALS, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 254, 23, 133, 12
	CONTROL	"", NEWPERSONWINDOW_MNAMEEXT, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 65, 36, 143, 13
	CONTROL	"Salutation", NEWPERSONWINDOW_MTITLE, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 254, 36, 133, 72
	...
	CONTROL	"", NEWPERSONWINDOW_MATTENTION, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 254, 66, 133, 12
	CONTROL	"", NEWPERSONWINDOW_MCOUNTRY, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 254, 80, 133, 12
	CONTROL	"", NEWPERSONWINDOW_MTELBUSINESS, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 65, 109, 143, 12
	CONTROL	"", NEWPERSONWINDOW_MTELHOME, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 254, 109, 133, 12
	CONTROL	"", NEWPERSONWINDOW_MFAX, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 65, 123, 143, 12
	CONTROL	"", NEWPERSONWINDOW_MMOBILE, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 254, 124, 133, 13
	...
	CONTROL	"", NEWPERSONWINDOW_MEMAIL, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 254, 146, 133, 12, WS_EX_CLIENTEDGE
	...
	CONTROL	"", NEWPERSONWINDOW_MCOD1, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 406, 51, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD2, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 406, 63, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD3, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 406, 75, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD4, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 406, 86, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD5, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 406, 98, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD6, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 406, 110, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD7, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 406, 121, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD8, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 406, 133, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD9, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 406, 145, 73, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD10, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 406, 156, 73, 72
	CONTROL	"OK", NEWPERSONWINDOW_OKBUTTON, "Button", BS_DEFPUSHBUTTON|WS_TABSTOP|WS_CHILD, 432, 6, 54, 12
	CONTROL	"Cancel", NEWPERSONWINDOW_CANCELBUTTON, "Button", WS_TABSTOP|WS_CHILD, 432, 24, 54, 12
	...
	CONTROL	"Mailing codes", NEWPERSONWINDOW_GROUPBOX1, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 400, 40, 86, 134
	...
	CONTROL	"", NEWPERSONWINDOW_MDATELASTGIFT, "Edit", ES_READONLY|ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 254, 288, 133, 12
	CONTROL	"", NEWPERSONWINDOW_MOPC, "Edit", ES_READONLY|ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 254, 300, 133, 13
	CONTROL	"Name:", NEWPERSONWINDOW_GROUPBOX2, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 6, 1, 388, 53
	CONTROL	"Address:", NEWPERSONWINDOW_GROUPBOX3, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 6, 57, 388, 40
	CONTROL	"Telephone:", NEWPERSONWINDOW_GROUPBOX4, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 6, 100, 388, 40
...
ACCESS mTit() CLASS NewPersonWindow
RETURN SELF:FieldGet(#mTit)

ASSIGN mTit(uValue) CLASS NewPersonWindow
SELF:FieldPut(#mTit, uValue)
RETURN uValue
	...
	*	aExtra: {New,AddressChanged,oCaller} or just: New
	...
	IF self:lNew
		...
		if !Empty(self:oPersCnt:m51_title) 
			...
			IF titPtr>0
				self:mTIT := pers_titles[titPtr,2]
			endif
		endif
		/*	IF !Empty(self:oPersCnt:m51_title)
		mTIT := self:oPersCnt:m51_title
		ENDIF */
...
METHOD PostInit(oParent,uExtra) CLASS SelPersExport
	...
	self:oDCExportFormat:Value:="TXT"
	RETURN NIL
...
BEGIN
	...
	CONTROL	"Possible values for:", SELPERSMAILCD_EXTRAPROPGROUP, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD|NOT WS_VISIBLE, 4, 233, 456, 14
...
CLASS SelPersMailCd INHERIT DialogWinDowExtra 
	...
	PROTECT oDCExtraPropGroup AS GROUPBOX
...
oDCExtraPropGroup := GroupBox{SELF,ResourceID{SELPERSMAILCD_EXTRAPROPGROUP,_GetInst()}}
oDCExtraPropGroup:HyperLabel := HyperLabel{#ExtraPropGroup,"Possible values for:",NULL_STRING,NULL_STRING}
...
// 	oCaller:aExtraProp:=aPropExValues
	...
	IF !empty(oDCDLG_Start:Value)
		oCaller:cWherep := oCaller:cWherep+;
		IF(.not.Empty(oCaller:cWherep),' and ',"")+'p.datelastgift>="'+DToC(self:oDCDLG_Start:VALUE)+'"'
	ENDIF
	IF !Empty(oDCDLG_End:VALUE)
		oCaller:cWherep := oCaller:cWherep+;
		IF(.not.Empty(oCaller:cWherep),' and ',"")+'p.datelastgift<="'+DToC(oDCDLG_End:VALUE)+'"'
		IF empty(oDCDLG_Start:Value)
			oCaller:cWherep := oCaller:cWherep+' and p.datelastgift>"0000-00-00"'
		ENDIF
	ENDIF
// 	IF !oDCBdat_Start:TextValue==DToC(NULL_DATE)
	IF !Empty(self:oDCBdat_Start:VALUE)
		oCaller:cWherep := oCaller:cWherep+;
		iif(!Empty(oCaller:cWherep),' and ',"")+'p.creationdate>="'+DToC(self:oDCBdat_Start:VALUE)+'"'
	ENDIF
	IF !Empty(oDCBdat_End:VALUE)
		oCaller:cWherep := oCaller:cWherep+;
		IF(.not.Empty(oCaller:cWherep),' and ',"")+'p.creationdate<="'+DToC(self:oDCBdat_End:VALUE)+'"'
		IF empty(oDCBdat_Start:Value)
			oCaller:cWherep := oCaller:cWherep+' and p.creationdate>"0000-00-00"'
		ENDIF
	ENDIF
	IF !empty(oDCMutd_Start:Value)
		oCaller:cWherep := oCaller:cWherep+;
		IF(.not.Empty(oCaller:cWherep),' and ',"")+'p.alterdate>="'+DToC(oDCMutd_Start:VALUE)+'"'
	ENDIF
	IF !Empty(oDCMutd_End:VALUE)
		oCaller:cWherep := oCaller:cWherep+;
		IF(.not.Empty(oCaller:cWherep),' and ',"")+'p.alterdate<="'+DToC(oDCMutd_End:VALUE)+'"'
		IF empty(oDCMutd_Start:Value)
			oCaller:cWherep := oCaller:cWherep+' and p.creationdate>"0000-00-00"'
		ENDIF
	ENDIF
	...
	IF !Empty(oDCeerste:TEXTvalue).or.!Empty(oDClaatste:TEXTvalue)
		oCaller:selx_voorw := oCaller:selx_voorw + ;
		IF(.not.Empty(oCaller:selx_voorw),' and ',"")+'Zip code between '+;
	...
	IF !oDCDLG_Start:TextValue==DToC(NULL_DATE).or.!oDCDLG_End:TextValue==DToC(NULL_DATE)
		oCaller:selx_voorw := oCaller:selx_voorw + ;
		IF(.not.Empty(oCaller:selx_voorw),' and ',"")+'Last Gift between '+;
	...
	IF !oDCMutd_Start:TextValue==DToC(NULL_DATE).or.!oDCMutd_End:TextValue==DToC(NULL_DATE)
		oCaller:selx_voorw := oCaller:selx_voorw + ;
		IF(.not.Empty(oCaller:selx_voorw),' and ',"")+'Last Altered between '+;
	...
	IF !oDCBdat_Start:TextValue==DToC(NULL_DATE).or.!oDCBdat_End:TextValue==DToC(NULL_DATE)
		oCaller:selx_voorw := oCaller:selx_voorw + ;
		IF(.not.Empty(oCaller:selx_voorw),' and ',"")+'Created between '+;
...
// 		oCaller:RepCompact := oDCReport1:Checked
// 		oCaller:RepExt := oDCReport2:Checked
// 		oCaller:RepLabel := oDCReport3:Checked
// 		oCaller:RepLetter := oDCReport4:Checked
// 		oCaller:RepGiro := oDCReport5:Checked
// 		oCaller:RepExport := oDCReport6:Checked
// 		oCaller:RepMailcds := oDCReport7:Checked
	if !Empty(self:oDCOutputAction:VALUE)
// 		self:oCaller:ReportAction:= Val(self:oDCOutputAction:TEXTvalue)
...
// 		oDCReport1:SetFocus()
		RETURN NIL
	ENDIF
	oCaller:SortOrder := oDCSortOrder:Value 
...
STATIC DEFINE SELPERSMAILCD_EXTRAPROPGROUP := 136 
