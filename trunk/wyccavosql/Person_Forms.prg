...
BEGIN
	...
	CONTROL	"", NEWPERSONWINDOW_MCOD1, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 59, 76, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD2, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 70, 76, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD3, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 82, 76, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD4, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 94, 76, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD5, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 105, 76, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD6, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 117, 76, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD7, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 129, 76, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD8, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 140, 76, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD9, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 152, 76, 72
	CONTROL	"", NEWPERSONWINDOW_MCOD10, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 410, 164, 76, 72
	...
	CONTROL	"Mailing codes", NEWPERSONWINDOW_GROUPBOX1, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 404, 48, 86, 134
