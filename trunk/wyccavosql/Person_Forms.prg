...
BEGIN
	...
	CONTROL	"", EDITPERSON_MCREATIONDATE, "Edit", ES_READONLY|ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_CLIPSIBLINGS|WS_BORDER, 65, 286, 143, 13
	CONTROL	"", EDITPERSON_MDATELASTGIFT, "Edit", ES_READONLY|ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 252, 288, 133, 12
	CONTROL	"", EDITPERSON_MALTERDATE, "Edit", ES_READONLY|ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_CLIPSIBLINGS|WS_BORDER, 65, 300, 143, 13, WS_EX_TRANSPARENT
	CONTROL	"", EDITPERSON_MOPC, "Edit", ES_READONLY|ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 252, 299, 133, 12
	CONTROL	"PersonNbr:", EDITPERSON_MPERSID, "Edit", ES_READONLY|ES_AUTOHSCROLL|WS_CHILD|WS_BORDER, 433, 288, 43, 12, WS_EX_TRANSPARENT
