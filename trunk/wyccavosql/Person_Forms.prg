...
BEGIN
	...
	CONTROL	"Name:", NEWPERSONWINDOW_GROUPBOX2, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 6, 0, 383, 54
	...
	CONTROL	"Undelete", NEWPERSONWINDOW_UNDELETE, "Button", BS_DEFPUSHBUTTON|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE, 442, 16, 46, 13
END
...
STATIC DEFINE NEWPERSONWINDOW_CANCELBUTTON := 156 
STATIC DEFINE NEWPERSONWINDOW_DELETEDTEXT := 177 
STATIC DEFINE NEWPERSONWINDOW_DONATIONSBUTTON := 176 
STATIC DEFINE NEWPERSONWINDOW_FIXEDTEXT21 := 157 
STATIC DEFINE NEWPERSONWINDOW_GIFTSBUTTON := 175 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOX1 := 160 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOX2 := 165 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOX3 := 166 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOX4 := 167 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOXPERSONAL := 170 
STATIC DEFINE NEWPERSONWINDOW_GROUPBOXSYSTEM := 168 
STATIC DEFINE NEWPERSONWINDOW_MADDRESS := 121 
STATIC DEFINE NEWPERSONWINDOW_MALTERDATE := 151 
STATIC DEFINE NEWPERSONWINDOW_MATTENTION := 124 
STATIC DEFINE NEWPERSONWINDOW_MBANKNUMBER := 130 
STATIC DEFINE NEWPERSONWINDOW_MBIRTHDATE := 137 
STATIC DEFINE NEWPERSONWINDOW_MCITY := 123 
STATIC DEFINE NEWPERSONWINDOW_MCOD1 := 139 
STATIC DEFINE NEWPERSONWINDOW_MCOD10 := 148 
STATIC DEFINE NEWPERSONWINDOW_MCOD2 := 140 
STATIC DEFINE NEWPERSONWINDOW_MCOD3 := 141 
STATIC DEFINE NEWPERSONWINDOW_MCOD4 := 142 
STATIC DEFINE NEWPERSONWINDOW_MCOD5 := 143 
STATIC DEFINE NEWPERSONWINDOW_MCOD6 := 144 
STATIC DEFINE NEWPERSONWINDOW_MCOD7 := 145 
STATIC DEFINE NEWPERSONWINDOW_MCOD8 := 146 
STATIC DEFINE NEWPERSONWINDOW_MCOD9 := 147 
STATIC DEFINE NEWPERSONWINDOW_MCOUNTRY := 125 
STATIC DEFINE NEWPERSONWINDOW_MCREATIONDATE := 149 
STATIC DEFINE NEWPERSONWINDOW_MDATELASTGIFT := 150 
STATIC DEFINE NEWPERSONWINDOW_MEMAIL := 133 
STATIC DEFINE NEWPERSONWINDOW_MEXTERNID := 154 
...
STATIC DEFINE NEWPERSONWINDOW_MOPC := 152 
STATIC DEFINE NEWPERSONWINDOW_MPERSID := 153 
STATIC DEFINE NEWPERSONWINDOW_MPOSTALCODE := 122 
STATIC DEFINE NEWPERSONWINDOW_MPREFIX := 116 
STATIC DEFINE NEWPERSONWINDOW_MPROPEXTR := 138 
...
STATIC DEFINE NEWPERSONWINDOW_OKBUTTON := 155 
STATIC DEFINE NEWPERSONWINDOW_SC_AD1 := 106 
STATIC DEFINE NEWPERSONWINDOW_SC_BANKNUMBER := 158 
STATIC DEFINE NEWPERSONWINDOW_SC_BDAT := 161 
STATIC DEFINE NEWPERSONWINDOW_SC_BDAT1 := 171 
STATIC DEFINE NEWPERSONWINDOW_SC_BDAT2 := 172 
STATIC DEFINE NEWPERSONWINDOW_SC_CLN := 159 
STATIC DEFINE NEWPERSONWINDOW_SC_DLG := 163 
STATIC DEFINE NEWPERSONWINDOW_SC_EXTERNID := 174 
...
STATIC DEFINE NEWPERSONWINDOW_SC_TEL3 := 169 
STATIC DEFINE NEWPERSONWINDOW_SC_TEL4 := 173 
STATIC DEFINE NEWPERSONWINDOW_SC_TIT := 105 
STATIC DEFINE NEWPERSONWINDOW_SC_VRN := 102 
STATIC DEFINE NEWPERSONWINDOW_UNDELETE := 178 
