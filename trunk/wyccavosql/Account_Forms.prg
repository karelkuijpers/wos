...
BEGIN
	...
	CONTROL	"10-5-2012", EDITACCOUNT_BALANCEDATE, "SysDateTimePick32", WS_TABSTOP|WS_CHILD, 36, 118, 70, 13
...
METHOD PostInit(oWindow,iCtlID,oServer,uExtra) CLASS EditAccount
	...
	ELSE
		...
		"reimb,a.active,a.monitor,a.clc,a.propxtra,a.giftalwd,a.qtymailing,ipcaccount,"+;
