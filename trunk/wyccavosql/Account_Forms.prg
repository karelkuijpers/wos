	...
	* Delete a account occurrence
	...
	IF ( oTextBox:Show() == BOXREPLYYES )
		...
		* Check if account net asset of a department:
    	...
    	ELSE
			oMBal:=Balances{}
			oMBal:GetBalance(cRek,oAccSelf:TYPE)
...
CLASS AccountBrowser_DETAIL INHERIT DataWindowExtra 
	...
	PROTECT oDBMACTIVE as DataColumn
...
oDBMACTIVE := DataColumn{6}
oDBMACTIVE:Width := 6
oDBMACTIVE:HyperLabel := HyperLabel{#mActive,"Active",NULL_STRING,NULL_STRING} 
oDBMACTIVE:Caption := "Active"
oDBmActive:Block := {|x|iif(x:active=0,'NO','')}
oDBmActive:BlockOwner := self:server
oDBmActive:TextColor := Color{COLORRED}
self:Browser:AddColumn(oDBMACTIVE)
...
RESOURCE EditAccount DIALOGEX  4, 3, 409, 376
STYLE	WS_CHILD
FONT	8, "MS Shell Dlg"
BEGIN
	...
	CONTROL	"Mailing Code:", EDITACCOUNT_SC_CLC, "Static", WS_CHILD, 8, 273, 45, 13
	...
	CONTROL	"Date:", EDITACCOUNT_FIXEDTEXT6, "Static", WS_CHILD, 8, 99, 23, 13
	CONTROL	"Account", EDITACCOUNT_GROUPBOX1, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 4, 8, 340, 84
	CONTROL	"Gain/Loss account:", EDITACCOUNT_GAINLOSSTEXT, "Static", WS_CHILD|NOT WS_VISIBLE, 224, 151, 64, 12
	CONTROL	"", EDITACCOUNT_MGAINLOSSACC, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 288, 151, 92, 12, WS_EX_CLIENTEDGE
	CONTROL	"v", EDITACCOUNT_GLACCBUTTON, "Button", WS_CHILD|NOT WS_VISIBLE, 380, 151, 15, 12
	CONTROL	"Balance", EDITACCOUNT_GROUPBOX2, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 0, 92, 368, 27
	CONTROL	"Of who is it:", EDITACCOUNT_FIXEDTEXT7, "Static", WS_CHILD, 184, 55, 42, 12
	CONTROL	"Budget:", EDITACCOUNT_GROUPBOX3, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 4, 169, 366, 87
	CONTROL	"", EDITACCOUNT_BALYEARS, "ComboBox", CBS_DISABLENOSCROLL|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 72, 177, 88, 72
	CONTROL	"Year:", EDITACCOUNT_FIXEDTEXT8, "Static", WS_CHILD, 9, 178, 53, 12
	CONTROL	"Budget per year", EDITACCOUNT_RADIOBUTTONYEAR, "Button", BS_AUTORADIOBUTTON|WS_CHILD, 72, 208, 80, 11
	CONTROL	"", EDITACCOUNT_MBALANCE, "Edit", ES_READONLY|ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 108, 99, 78, 13, WS_EX_CLIENTEDGE
	CONTROL	"Budget per month", EDITACCOUNT_RADIOBUTTONMONTH, "Button", BS_AUTORADIOBUTTON|WS_CHILD, 72, 221, 80, 11
	CONTROL	"Amount:", EDITACCOUNT_FIXEDTEXT9, "Static", WS_CHILD, 168, 179, 28, 12
	CONTROL	"Jan:", EDITACCOUNT_TEXTBUD1, "Static", WS_CHILD|NOT WS_VISIBLE, 202, 179, 18, 12
	CONTROL	"Feb:", EDITACCOUNT_TEXTBUD2, "Static", WS_CHILD|NOT WS_VISIBLE, 202, 190, 18, 13
	CONTROL	"Budget:", EDITACCOUNT_MBUD1, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 222, 179, 54, 12
	CONTROL	"Budget:", EDITACCOUNT_MBUD2, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 222, 190, 54, 13
	CONTROL	"Budget:", EDITACCOUNT_MBUD3, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 222, 201, 54, 13
	CONTROL	"Budget:", EDITACCOUNT_MBUD4, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 222, 213, 54, 12
	CONTROL	"Budget:", EDITACCOUNT_MBUD5, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 222, 224, 54, 12
	CONTROL	"Budget:", EDITACCOUNT_MBUD6, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 222, 236, 54, 12
	CONTROL	"Budget:", EDITACCOUNT_MBUD7, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 304, 179, 53, 13
	CONTROL	"Budget:", EDITACCOUNT_MBUD8, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 304, 191, 53, 12
	CONTROL	"Budget:", EDITACCOUNT_MBUD9, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 304, 203, 53, 12
	CONTROL	"Budget:", EDITACCOUNT_MBUD10, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 304, 214, 53, 13
	CONTROL	"Budget:", EDITACCOUNT_MBUD11, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 304, 225, 53, 13
	CONTROL	"Budget:", EDITACCOUNT_MBUD12, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 304, 237, 53, 12
	CONTROL	"Mar:", EDITACCOUNT_TEXTBUD3, "Static", WS_CHILD|NOT WS_VISIBLE, 202, 201, 18, 13
	CONTROL	"Apr:", EDITACCOUNT_TEXTBUD4, "Static", WS_CHILD|NOT WS_VISIBLE, 202, 213, 18, 12
	CONTROL	"Jun:", EDITACCOUNT_TEXTBUD6, "Static", WS_CHILD|NOT WS_VISIBLE, 202, 236, 18, 12
	CONTROL	"May:", EDITACCOUNT_TEXTBUD5, "Static", WS_CHILD|NOT WS_VISIBLE, 202, 224, 17, 12
	...
	CONTROL	"Dec:", EDITACCOUNT_TEXTBUD12, "Static", WS_CHILD|NOT WS_VISIBLE, 285, 237, 18, 12
	CONTROL	"Nov:", EDITACCOUNT_TEXTBUD11, "Static", WS_CHILD|NOT WS_VISIBLE, 285, 225, 18, 13
	CONTROL	"Oct:", EDITACCOUNT_TEXTBUD10, "Static", WS_CHILD|NOT WS_VISIBLE, 285, 214, 18, 13
	CONTROL	"Sep:", EDITACCOUNT_TEXTBUD9, "Static", WS_CHILD|NOT WS_VISIBLE, 285, 203, 17, 12
	CONTROL	"Aug:", EDITACCOUNT_TEXTBUD8, "Static", WS_CHILD|NOT WS_VISIBLE, 285, 191, 18, 12
	CONTROL	"Jul:", EDITACCOUNT_TEXTBUD7, "Static", WS_CHILD|NOT WS_VISIBLE, 285, 179, 18, 13
	CONTROL	"Budget granularity:", EDITACCOUNT_BUDGETGRANULARITY, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 67, 199, 93, 38
	CONTROL	"Default person parameter values for givers/payers to this account:", EDITACCOUNT_DEFAULTBOX, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 0, 262, 366, 107
	CONTROL	"", EDITACCOUNT_MCOD3, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 196, 272, 61, 72
	CONTROL	"", EDITACCOUNT_MCOD2, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 131, 272, 61, 72
	CONTROL	"", EDITACCOUNT_MCOD1, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWNLIST|WS_TABSTOP|WS_CHILD|WS_VSCROLL, 68, 272, 61, 72
	CONTROL	"Extra properties for new persons:", EDITACCOUNT_XTRTEXT, "Static", WS_CHILD|NOT WS_VISIBLE, 8, 291, 164, 12
	CONTROL	"change value:", EDITACCOUNT_VALUETEXT, "Static", WS_CHILD|NOT WS_VISIBLE, 232, 291, 136, 13
	CONTROL	"", EDITACCOUNT_PROPVALUECOMBO, "ComboBox", CBS_DISABLENOSCROLL|CBS_SORT|CBS_DROPDOWN|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_VSCROLL, 232, 302, 133, 59
	CONTROL	"", EDITACCOUNT_PROPBOX, "ListBox", LBS_DISABLENOSCROLL|LBS_NOINTEGRALHEIGHT|LBS_SORT|LBS_NOTIFY|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER|WS_VSCROLL, 4, 302, 216, 63, WS_EX_CLIENTEDGE
	CONTROL	"", EDITACCOUNT_PROPVALUESINGLE, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 232, 302, 133, 13, WS_EX_CLIENTEDGE
	CONTROL	"Currency:", EDITACCOUNT_CURRTEXT, "Static", WS_CHILD, 80, 137, 32, 12
	CONTROL	"Currencies ", EDITACCOUNT_GROUPBOX4, "Button", BS_GROUPBOX|WS_GROUP|WS_CHILD, 4, 125, 396, 44
	CONTROL	"Fixed Text", EDITACCOUNT_TEXTSYSCUR, "Static", WS_CHILD, 188, 99, 24, 13
	CONTROL	"", EDITACCOUNT_MBALANCEF, "Edit", ES_READONLY|ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|NOT WS_VISIBLE|WS_BORDER, 216, 99, 78, 13, WS_EX_CLIENTEDGE
	CONTROL	"Fixed Text", EDITACCOUNT_TEXTFORGNCUR, "Static", WS_CHILD|NOT WS_VISIBLE, 296, 99, 20, 13
	CONTROL	"IPC Account:", EDITACCOUNT_IPCTEXT, "Static", WS_CHILD|NOT WS_VISIBLE, 12, 73, 53, 13
...
oDCmSubscriptionprice:HyperLabel := HyperLabel{#mSubscriptionprice,"Subscriptionprice:","Optionally price of a subscription","Rek_ABP"}
...
if !Empty(IPCProj) .and. (self:mSoort="BA" .or. self:mSoort="KO")
...
STATIC DEFINE EDITACCOUNT_BALANCEDATE := 113 
STATIC DEFINE EDITACCOUNT_BALBUTTON := 109 
STATIC DEFINE EDITACCOUNT_BALYEARS := 125 
STATIC DEFINE EDITACCOUNT_BUDGETGRANULARITY := 157 
STATIC DEFINE EDITACCOUNT_CANCELBUTTON := 150 
STATIC DEFINE EDITACCOUNT_CURRTEXT := 167 
STATIC DEFINE EDITACCOUNT_DEFAULTBOX := 158 
STATIC DEFINE EDITACCOUNT_DEPBUTTON := 111 
STATIC DEFINE EDITACCOUNT_FIXEDTEXT6 := 117 
STATIC DEFINE EDITACCOUNT_FIXEDTEXT7 := 123 
STATIC DEFINE EDITACCOUNT_FIXEDTEXT8 := 126 
STATIC DEFINE EDITACCOUNT_FIXEDTEXT9 := 130 
STATIC DEFINE EDITACCOUNT_GAINLOSSTEXT := 119 
STATIC DEFINE EDITACCOUNT_GLACCBUTTON := 121 
STATIC DEFINE EDITACCOUNT_GROUPBOX1 := 118 
STATIC DEFINE EDITACCOUNT_GROUPBOX2 := 122 
STATIC DEFINE EDITACCOUNT_GROUPBOX3 := 124 
STATIC DEFINE EDITACCOUNT_GROUPBOX4 := 168 
STATIC DEFINE EDITACCOUNT_IPCTEXT := 172 
STATIC DEFINE EDITACCOUNT_MACCNUMBER := 105 
STATIC DEFINE EDITACCOUNT_MACTIVE := 175 
STATIC DEFINE EDITACCOUNT_MBALANCE := 128 
STATIC DEFINE EDITACCOUNT_MBALANCEF := 170 
STATIC DEFINE EDITACCOUNT_MBALITEMID := 108 
STATIC DEFINE EDITACCOUNT_MBUD1 := 133 
STATIC DEFINE EDITACCOUNT_MBUD10 := 142 
STATIC DEFINE EDITACCOUNT_MBUD11 := 143 
STATIC DEFINE EDITACCOUNT_MBUD12 := 144 
STATIC DEFINE EDITACCOUNT_MBUD2 := 134 
STATIC DEFINE EDITACCOUNT_MBUD3 := 135 
STATIC DEFINE EDITACCOUNT_MBUD4 := 136 
STATIC DEFINE EDITACCOUNT_MBUD5 := 137 
STATIC DEFINE EDITACCOUNT_MBUD6 := 138 
STATIC DEFINE EDITACCOUNT_MBUD7 := 139 
STATIC DEFINE EDITACCOUNT_MBUD8 := 140 
STATIC DEFINE EDITACCOUNT_MBUD9 := 141 
STATIC DEFINE EDITACCOUNT_MCOD1 := 161 
STATIC DEFINE EDITACCOUNT_MCOD2 := 160 
STATIC DEFINE EDITACCOUNT_MCOD3 := 159 
...
STATIC DEFINE EDITACCOUNT_MIPCACCOUNT := 173 
STATIC DEFINE EDITACCOUNT_MMULTCURR := 114 
STATIC DEFINE EDITACCOUNT_MNUM := 108 
STATIC DEFINE EDITACCOUNT_MOMS := 107 
STATIC DEFINE EDITACCOUNT_MREEVALUATE := 116 
STATIC DEFINE EDITACCOUNT_MREIMB := 174 
STATIC DEFINE EDITACCOUNT_MSUBSCRIPTIONPRICE := 112 
STATIC DEFINE EDITACCOUNT_OKBUTTON := 149 
STATIC DEFINE EDITACCOUNT_PROPBOX := 165 
STATIC DEFINE EDITACCOUNT_PROPVALUECOMBO := 164 
STATIC DEFINE EDITACCOUNT_PROPVALUESINGLE := 166 
STATIC DEFINE EDITACCOUNT_RADIOBUTTONMONTH := 129 
STATIC DEFINE EDITACCOUNT_RADIOBUTTONYEAR := 127 
...
STATIC DEFINE EDITACCOUNT_TEXTBUD1 := 131 
STATIC DEFINE EDITACCOUNT_TEXTBUD10 := 153 
STATIC DEFINE EDITACCOUNT_TEXTBUD11 := 152 
STATIC DEFINE EDITACCOUNT_TEXTBUD12 := 151 
STATIC DEFINE EDITACCOUNT_TEXTBUD2 := 132 
STATIC DEFINE EDITACCOUNT_TEXTBUD3 := 145 
STATIC DEFINE EDITACCOUNT_TEXTBUD4 := 146 
STATIC DEFINE EDITACCOUNT_TEXTBUD5 := 148 
STATIC DEFINE EDITACCOUNT_TEXTBUD6 := 147 
STATIC DEFINE EDITACCOUNT_TEXTBUD7 := 156 
STATIC DEFINE EDITACCOUNT_TEXTBUD8 := 155 
STATIC DEFINE EDITACCOUNT_TEXTBUD9 := 154 
STATIC DEFINE EDITACCOUNT_TEXTFORGNCUR := 171 
STATIC DEFINE EDITACCOUNT_TEXTSYSCUR := 169 
STATIC DEFINE EDITACCOUNT_VALUETEXT := 163 
STATIC DEFINE EDITACCOUNT_XTRTEXT := 162 
