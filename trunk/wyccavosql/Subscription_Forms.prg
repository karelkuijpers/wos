...
BEGIN
	...
	CONTROL	"23-09-2010", EDITSUBSCRIPTION_MBEGINDATE, "SysDateTimePick32", WS_TABSTOP|WS_CHILD, 68, 40, 83, 14
	CONTROL	"23-09-2010", EDITSUBSCRIPTION_MDUEDATE, "SysDateTimePick32", WS_TABSTOP|WS_CHILD, 68, 55, 83, 13
	CONTROL	"Term in months:", EDITSUBSCRIPTION_MTERM, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 68, 73, 83, 11, WS_EX_CLIENTEDGE
	CONTROL	"Periodic amount:", EDITSUBSCRIPTION_MAMOUNT, "Edit", ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 68, 88, 83, 12, WS_EX_CLIENTEDGE
	...
	CONTROL	"Alter date:", EDITSUBSCRIPTION_MLSTCHANGE, "Edit", ES_READONLY|ES_AUTOHSCROLL|WS_TABSTOP|WS_CHILD|WS_BORDER, 44, 140, 50, 12, WS_EX_CLIENTEDGE
	...
	CONTROL	"23-09-2010", EDITSUBSCRIPTION_MENDDATE, "SysDateTimePick32", WS_TABSTOP|WS_CHILD, 180, 40, 83, 14
...
oDCmterm:HyperLabel := HyperLabel{#mterm,"Term in months:",NULL_STRING,NULL_STRING}
oDCmterm:Picture := "9999"

oDCmamount := mySingleEdit{SELF,ResourceID{EDITSUBSCRIPTION_MAMOUNT,_GetInst()}}
oDCmamount:HyperLabel := HyperLabel{#mamount,"Periodic amount:",NULL_STRING,NULL_STRING}
...
oDCmLstchange:HyperLabel := HyperLabel{#mLstchange,"Alter date:",NULL_STRING,NULL_STRING}
