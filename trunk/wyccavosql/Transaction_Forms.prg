...
BEGIN
	...
	CONTROL	"donderdag 26 april 2012", GENERAL_JOURNAL_MDAT, "SysDateTimePick32", DTS_LONGDATEFORMAT|WS_TABSTOP|WS_CHILD, 140, 1, 132, 13
...
oTrans:=SQLStatement{"update transaction set poststatus=2,userid='"+LOGON_EMP_ID+"' where transid="+self:mTRANSAKTNR,oConn}
oTrans:Execute() 
...
STATIC DEFINE GENERAL_JOURNAL_FOUND := 131 
STATIC DEFINE GENERAL_JOURNAL_FOUNDTEXT := 130 
...
BEGIN
	...
	CONTROL	"donderdag 26 april 2012", PAYMENTJOURNAL_MDAT, "SysDateTimePick32", DTS_LONGDATEFORMAT|WS_TABSTOP|WS_CHILD, 120, 1, 124, 14
	...
	CONTROL	"", PAYMENTJOURNAL_MTRANSAKTNR, "Edit", ES_READONLY|ES_AUTOHSCROLL|ES_NUMBER|WS_CHILD|WS_BORDER, 392, 3, 41, 11
